...
fn main () {
    ...
    let deciman: f32 = 4.2;
    let letter: char = 'a'; //single quotes
    let phrase =  String ::from("Don't panic");
    ...
    //slice
    let slice1 = &sample_array[0..2]; //slicing from a pointer, 
    ...
    println!("This is an array {:?}", sample_array);
    println!("This is an array of characters:{:?} ", sample_array2);
